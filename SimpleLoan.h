/********************************************************
* Title: SimpleLoan.h
* Description: This is the header file for the function file SimpleLoan.cpp, this file will set up the class and functions for the functions file.
...
//this will be the class for the SimpleLoan implementation 
class SimpleLoan : public Loan // will be use the public from the class loan
{
   public: 
   SimpleLoan();
